...
{
    public partial class ConsultaInspeccionDocumentosDescargar : System.Web.UI.Page
    {
        ...
        {
            string CommandArgument = Request.QueryString["Argument"];

            int documento_id, tipo, numseccion, desahogo = 0;
            string plantilla;
            String[] info = CommandArgument.ToString().Split('|');
            ...
            int.TryParse(info[5], out midtoB.inspeccion_id);
            int.TryParse(info[6], out midtoB.subtipo_inspeccion_id);
            int.TryParse(info[7], out midtoB.operativo_id);
            int.TryParse(info[8], out midtoB.materia_id);
            midtoB.materia = info[9];
            int.TryParse(info[10], out midtoB.in_etapa);
            midtoB.num_expediente = info[11];
            midtoB.subtipo = info[12];
            midtoB.fec_inspeccion = info[13];
            int.TryParse(info[14], out midtoB.desahogo_id);
            //string midocumento_id = CommandName.ToString();
